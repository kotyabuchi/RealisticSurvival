...
data class Home(val homeId: Int?, var name: String, val world: World, val x: Double, val y: Double, val z: Double, val yaw: Float, var icon: Material, val creator: UUID? = null, var isPublic: Boolean = false) {
